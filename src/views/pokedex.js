export default function Pokedex() {
  return (
    <div class="pokemonRow">
      <div class="pokeCard--fire">
        <div class="pokeCard_content">
          <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/4.png" class="pokeCard__image" />
          <div class="pokeCard__box">
            <div class="pokeCard__imageSpace"></div>
            <h3 class="pokeCard__name">Charmander</h3>
            <div class="pokeCard__typesContainer">
              <div class="pokeCard__typeContainer">
                <div class="pokeCard__typeBackdrop"></div>
                <p class="pokeCard__type">dragon</p>
                <div class="pokeCard__typeOverlay"></div>
              </div>
              <div class="pokeCard__typeContainer">
                <div class="pokeCard__typeBackdrop"></div>
                <p class="pokeCard__type">dragon</p>
        ...
        <svg class="pokeCard__background" width="240" height="110" viewBox="0 0 240 110" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g mask="url(#mask0)">
            <rect class="pokeCard__colorLayer" width="240" height="110" rx="55" fill="inherit" />
